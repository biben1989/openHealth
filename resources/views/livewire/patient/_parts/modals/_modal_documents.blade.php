            ...
            <x-slot name="form">
                    ...
                    <x-forms.form-group class="xl:w-1/2">
                        ...
                        <x-slot name="input">
                            <x-forms.select id="documents_type"
                                            wire:model.defer="patient_request.documents.type"
                        ...
                        @error('patient_request.documents.type')
                        <x-slot name="error">
                            <x-forms.error>
                                {{ $message }}
                            </x-forms.error>
                    ...
                    <x-forms.form-group class="xl:w-1/2">
                        ...
                        <x-slot name="input">
                            <x-forms.input class="default-input" id="documents_number"
                                           wire:model="patient_request.documents.number"
                                           type="text"
                            />
                        </x-slot>
                        @error('patient_request.documents.number')
                        <x-slot name="error">
                            <x-forms.error>
                                {{ $message }}
                            </x-forms.error>
                    ...
                    <x-forms.form-group class="xl:w-1/2">
                        ...
                        <x-slot name="input">
                            <x-forms.input class="default-input" id="documents_issued_by"
                                           wire:model="patient_request.documents.issued_by"
                                           type="text"
                                           placeholder="{{ __('forms.document_issued_by') }}"/>
                        </x-slot>
                        @error('patient_request.documents.issued_by')
                        <x-slot name="error">
                            <x-forms.error>
                                {{ $message }}
                            </x-forms.error>
                    ...
                    <x-forms.form-group class="xl:w-1/2">
                        ...
                        <x-slot name="input">
                            <x-forms.input class="default-input" id="documents_issued_at"
                                           wire:model="patient_request.documents.issued_at"
                                           type="date"
                            />
                        </x-slot>
                        @error('patient_request.documents.issued_at')
                        <x-slot name="message">
                            <x-forms.error>
                                {{ $message }}
                            </x-forms.error>
                ...
                <div class="mb-4 flex flex-col gap-6 xl:flex-row">
                    ...
                    <x-forms.form-group class="xl:w-1/2">
                        ...
                        <x-slot name="input">
                            <x-forms.input class="default-input" id="unzr"
                                           wire:model="patient_request.documents.unzr"
                                           type="text"
                            />
                        </x-slot>
                        @error('patient_request.documents.unzr')
                        <x-slot name="error">
                            <x-forms.error>
                                {{ $message }}
                            </x-forms.error>
