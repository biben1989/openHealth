<div>
    ...
    <div class="mb-4 flex flex-col gap-6 xl:flex-row">
        <x-forms.form-group class="xl:w-1/3">
            <x-slot name="label">
                <x-forms.label for="codeword" class="default-label">
                    {{ __('forms.codeword') }} *
                </x-forms.label>
            </x-slot>
            <x-slot name="input">
                <x-forms.input class="default-input" wire:model="patient_request.contact_data.codeword" type="text"
                               id="codeword"/>
            </x-slot>
            @error('patient_request.contact_data.codeword')
            <x-slot name="error">
                <x-forms.error>
                    {{ $message }}
                </x-forms.error>
