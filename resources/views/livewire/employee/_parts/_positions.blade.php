<div class="mb-4">
    ...
    <table class="w-full table-auto">
        ...
        @isset($employee->positions)
                <tr>
                    ...
                    <td>
                        <a wire:click.prevent="edit('positions')" href="">
    ...
    @if(empty($employee->positions))
        <div class="mb-6 mt-6 flex flex-wrap gap-5 xl:gap-7.5">
            <a wire:click.prevent="create('positions')" class="text-primary" href="">Додати Посаду</a>
        </div>
    @endif
