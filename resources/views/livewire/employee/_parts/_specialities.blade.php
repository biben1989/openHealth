<div class="mb-4">
    ...
    <table class="w-full table-auto">
        ...
        <tbody>
        <tr>
        @isset($employee->specialities)
            @foreach($employee->specialities as $k=>$speciality)
                <tr>
    ...
    <div class="mb-6 mt-6 flex flex-wrap gap-5 xl:gap-7.5">
        <a wire:click.prevent="create('specialities')" class="text-primary" href="">Додати спеціальність</a>
    </div>
