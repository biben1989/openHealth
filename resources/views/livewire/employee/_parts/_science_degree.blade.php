...
{{--            @foreach($employee->scienceDegree as $k=>$scienceDegree)--}}
                <tr>
                    ...
                    <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <a wire:click.prevent="edit('scienceDegree')" href="">
...
{{--            @endforeach--}}
    ...
    <div class="mb-6 mt-6 flex flex-wrap gap-5 xl:gap-7.5">
        ...
        <a wire:click.prevent="openModal('scienceDegree')" class="text-primary" href="">{{__('forms.addScienceDegree')}}</a>
        @endif
    </div>
