            ...
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    ...
                    @if(empty(auth()->user()->legalEntity) )
                        <li>
                            <a class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                            href="{{route('create.legalEntities')}}">
                    ...
                    <li>
                        ...
                        >
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                  sidebar-toggle-item=""> {{__('Договори')}}</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                           href="{{route('license.index')}}">
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                  sidebar-toggle-item=""> {{ __('Ліцензії') }}</span>
                        </a>
                    </li>

                    <li>
                        <a class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                           href="{{route('declaration.index')}}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                 stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                  sidebar-toggle-item="">{{ __('Декларація') }} </span>
                        </a>
                    </li>
                    @endhasanyrole
                    ...
                    <li>
                        ...
                        <a class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                           href="{{route('patient.index')}}">
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                  sidebar-toggle-item="">{{ Str::ucfirst(__('patients.patients')) }} </span>
                        </a>
                    </li>
                    @endhasanyrole
                    ...
                    <li>
                        <a class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                           href="{{route('profile.show')}}">
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                  sidebar-toggle-item="">  Профіль</span>
                        </a>
                    </li>
