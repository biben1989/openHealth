                            ...
                            <x-slot name="tbody">
                                @foreach($declarations as  $declaration)
                                    <tr>
                                        ...
                                        <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400 ">
                                            <a href="tel:{{$declaration->phone}}" class="inline-flex items-center font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                                {{$declaration->phone}}
                                            </a>
                                        </td>
                                        <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400 ">
                                        ...
                                        <td>
                                            <a href="#"
                                               wire:click="showDeclaration({{ json_encode($declaration) }})">
